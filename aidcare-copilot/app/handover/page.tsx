          ...
          <>
            ...
            <div className="max-w-3xl mx-auto py-8 px-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-8 mb-6 shadow-sm">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-slate-900">AidCare Copilot</h2>
                ...
                {report.handover_notes && (
                  <div className="mb-5 p-4 rounded-lg bg-amber-50 border border-amber-200">
                    <p className="text-xs font-semibold text-amber-800 uppercase tracking-wider mb-1">Additional Handover Notes</p>
                    <p className="text-sm text-slate-700 whitespace-pre-wrap">{report.handover_notes}</p>
                  </div>
                )}
              ...
              <p className="text-center text-xs text-slate-400">
                Generated by AidCare Copilot &bull; Confidential Patient Information &bull; Do Not Distribute Unauthorized Copies
              </p>
            </div>
          </>
        )}
